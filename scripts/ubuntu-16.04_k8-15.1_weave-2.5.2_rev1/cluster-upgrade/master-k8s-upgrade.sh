...
echo 'upgrading packages to: kubelet=1.15.7-00 kubeadm=1.15.7-00 kubectl=1.15.7-00 kubernetes-cni=0.7.5-00'
...
apt-get -q install -y kubelet=1.15.7-00 kubeadm=1.15.7-00 kubectl=1.15.7-00 kubernetes-cni=0.7.5-00 --allow-unauthenticated
