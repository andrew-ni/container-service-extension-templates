...
apt-get -q update -o Acquire::https::No-Cache=True -o Acquire::http::No-Cache=True -o Acquire::BrokenProxy=True -o Acquire::http::Pipeline-Depth=0 -o Acquire::https::Pipeline-Depth=0
